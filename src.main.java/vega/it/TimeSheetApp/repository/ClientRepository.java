...
public interface ClientRepository extends JpaRepository<Client, Integer> {
	...
	@Query(value = "SELECT DISTINCT c.client_id, c.address, c.city, c.client_name, c.deleted,c.zip_code, c.country_id, tm.team_member_id, tm.username"
			+ " FROM client c JOIN project p ON p.client_id = c.client_id  "
			+ "JOIN team_members tm ON tm.team_member_id = p.team_member_id "
